...
import shop.services.JavaMarshaller;
...
public class CustomerResourceJaxBTest
{
   ...
   @Test
   public void testCustomerResourcejaxb() throws Exception
   {
      ...
      Response response = client.target("http://localhost:8080/services/customersjaxb")
